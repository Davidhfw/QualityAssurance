...
if __name__ == "__main__":
    characters = ["Chinese", "LowerLetter", "UpperLetter", "Digits", "-_"]
    lst, s = convert_characters_to_list(characters)
    print(s)
    prohibited_characters = string.punctuation + string.whitespace
    prohibited_prefix = prohibited_suffix = "-_"
    length_range = [8, 64]
    right, wrong = generate_all_combines_by_rules(length_range, characters, prohibited_characters, prohibited_prefix, prohibited_suffix, 3)
